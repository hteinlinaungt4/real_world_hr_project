    ...
    <div class="row justify-content-center align-content-center">
        <div class="col-md-10">
           <div class="card px-3 border-0 shadow mt-5" >
            <div class="card-body">
                <form action="{{ route('role.update',$role->id) }}" method="post" id="create" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                               ...
                               @foreach($permissions as $permission)
                                <div class="col-3">
                                    <div class="form-check">
                                        <input class="form-check-input" name="permissions[]" type="checkbox" @if( in_array($permission->id,$oldpermission) ) checked @endif value="{{$permission->id}}" id="{{$permission->id}}">
...
@endsection
@section('script')
{!! JsValidator::formRequest('App\Http\Requests\UpdateRole', '#create') !!}
    <script>
